...
# Parsing Script – Hidrómetro Shengda - Rev. B

This **Parsing** script is designed for the **Hidrómetro Shengda** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Parsing – Hidrómetro Shengda Rev. B

Este script de **Parsing** está diseñado para el modelo **Hidrómetro Shengda** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
